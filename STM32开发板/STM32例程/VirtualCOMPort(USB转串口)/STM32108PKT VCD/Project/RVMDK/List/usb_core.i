...
#line 18 "..\\..\\..\\Libraries\\STM32_USB-FS-Device_Driver\\src\\usb_core.c"
    ...
    else
    {
      ...
      if ((((uint16_t)((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x3000)) == (0x1000)))
      {
        if (Related_Endpoint == ((uint8_t)0))
        {
          ...
          { register uint16_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & (0x3000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x3000))!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)_wRegVal); };
        }
        else
        {
...
RESULT Standard_SetEndPointFeature(void)
{
  ...
  else
  {
    if (wIndex0 & 0x80)
    {
      ...
      { register uint16_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x0030)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x0010) & (0x0010))!= 0) _wRegVal ^= (0x0010); if(((0x0020) & (0x0010))!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)_wRegVal); };
    }

    else
    {
       
      { register uint16_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & (0x1000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x1000))!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)_wRegVal); };
    }
  }
...
void SetDeviceAddress(uint8_t Val)
{
  ...
  for (i = 0; i < nEP; i++)
  {
    (*(((volatile unsigned *)((0x40005C00L))) + (uint8_t)i)= (uint16_t)((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + (uint8_t)i))) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F)) | (uint8_t)i);
  }  
