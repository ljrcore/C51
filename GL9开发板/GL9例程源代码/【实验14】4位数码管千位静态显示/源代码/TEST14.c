...
void main(void)            //主函数,单片机开机后就是从这个函数开始运行
{
    ...
    U16A0=1;               //U16A0=1,U16A1=1,U16A2=0,选通数码管的千位进行显示
    U16A1=1;               //U16A0=1,U16A1=1,U16A2=0,选通数码管的千位进行显示
    U16A2=0;               //U16A0=1,U16A1=1,U16A2=0,选通数码管的千位进行显示   
    //****数码管显示"0"****
    P2=LED[0];             //查表取"0"的字形数据送至P2显示
    //************************
