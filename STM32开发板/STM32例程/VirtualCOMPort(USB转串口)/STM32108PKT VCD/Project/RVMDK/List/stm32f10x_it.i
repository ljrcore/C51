...
void TIM2_IRQHandler(void)
{
  ...
  {
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CR1 &= ((uint16_t)0x03FE);                           
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->SR = (u16)~((uint16_t)0x0002);                        
